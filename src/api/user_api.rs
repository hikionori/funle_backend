...
/* 
TODO: Подумать над реализацией работоы с прогрессом пользователя.
То есть где должны находится пути для обновления прогресса пользователя. В пользовательском апи или разбить на все апи.
*/